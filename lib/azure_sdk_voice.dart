...
class AzureSdkVoice {
  ...
  Future<String?> pronunciationScore(String name,String language,String topic) {
    return AzureSdkVoicePlatform.instance.pronunciationScore(name,language,topic);
  }

  Future<String?> translate(String name,String recLanguage,String toLanguage) {
    return AzureSdkVoicePlatform.instance.translate(name,recLanguage,toLanguage);
  }
